...
# read the file
phenotypes<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE/PhenoData/20240201_R3E3_R1&R2_processed_data.csv", sep=";")
head(phenotypes)
...
traits <- c("Area_Endophyte", "Area_halo", "Area_inhibition")
...
BLUPS<-data.frame(Isolate=rownames(ranef(ModelLMEArea_Endophyte)$line), BLUPArea_Endophyte, BLUPArea_halo, BLUPArea_inhibition)
BLUPS[1:5,]
traits
