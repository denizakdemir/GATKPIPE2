...
new_dir <- "DataforPillarApr25_filtered"
...
load("DataforPillarApr25_filtered/DataforPillar.RData")
...
save(PhenoGWASR3E3, GenoMat13_thinned,mapping13_thinned,file="DataforPillarApr25_filtered/DataforPillarGWAS.RData")

# calculate the Kmat
Kmat<-rrBLUP::A.mat(GenoMat13_thinned[, -1]-1, min.MAF = .1, max.missing = .3)

# save Kmat, GenoMat13_thinned, mapping13_thinned 
save(Kmat, GenoMat13_thinned, mapping13_thinned, file = "DataforPillarApr25_filtered/GenoDataSeptoria100.RData")
