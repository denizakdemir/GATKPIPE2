...
load("DataforPillarApr25_filtered/DataforPillarGWAS.RData")
...
new_dir <- "GWAS_resultsForPilarsTraitsApr25_WithFIlter"
...
setwd("GWAS_resultsForPilarsTraitsApr25_WithFIlter")
dim(BLUPS)
...
###############
getwd()
setwd("Rscripts/GWAS_resultsForPilarsTraitsApr25_WithFIlter")
