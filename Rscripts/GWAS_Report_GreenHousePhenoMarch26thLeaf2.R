...
# select only leave_id==2
phenotypes<-phenotypes[phenotypes$leave_id==2,]
...
# make a folder to save the output files "GWASforPilarTraitsMarch27thLeaf2"
if (!file.exists("GWASforGreenHouseTraitsMarch27thLeaf2")){
dir.create("GWASforGreenHouseTraitsMarch27thLeaf2", showWarnings = FALSE)
}


setwd("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thLeaf2")
tmp<-capture.output({
modK <- GAPIT(Y=BLUPS,
                GD=GenoMat13,
                GM=mapping,
...
if (!file.exists("GWASforGreenHouseTraitsMarch27thThinnedSnpsLeaf2")){
  dir.create("GWASforGreenHouseTraitsMarch27thThinnedSnpsLeaf2", showWarnings = FALSE)
}

setwd("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsLeaf2")
...
if (!file.exists("GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf2")){
  dir.create("GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf2", showWarnings = FALSE)
}

setwd("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf2")
