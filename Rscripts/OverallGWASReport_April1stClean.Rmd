...
dfBLINK.BLUPmeanPycnidiaArea<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27th/GAPIT.Association.GWAS_Results.BLINK.BLUPmeanPycnidiaArea.csv")
...
GWASDFSel<-data.frame(SNP=dfBLINK.BLUPPLACL$SNP,Chromosome=dfBLINK.BLUPPLACL$Chr,Position=dfBLINK.BLUPPLACL$Pos, pycnidiaCount=dfBLINK.BLUPpycnidiaCount$P.value,meanPycnidiaArea=dfBLINK.BLUPmeanPycnidiaArea$P.value)
```
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCor/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```
...
dfBLINK.BLUPpycnidiaPerCm2Leaf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnps/GAPIT.Association.GWAS_Results.BLINK.BLUPpycnidiaPerCm2Leaf.csv")
dfBLINK.BLUPpycnidiaPerCm2Lesion<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnps/GAPIT.Association.GWAS_Results.BLINK.BLUPpycnidiaPerCm2Lesion.csv")
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf2/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```

```{r, echo=FALSE}
dfBLINK.BLUPPLACL<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf2/GAPIT.Association.GWAS_Results.BLINK.BLUPPLACL.csv")
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf3/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```

```{r, echo=FALSE}
dfBLINK.BLUPPLACL<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforGreenHouseTraitsMarch27thThinnedSnpsWithCorLeaf3/GAPIT.Association.GWAS_Results.BLINK.BLUPPLACL.csv")
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforPilarTraitsMarch27th/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```
...
```{r, echo=FALSE}
source("https://raw.githubusercontent.com/YinLiLin/CMplot/master/R/CMplot.r")
dfBLINK.BLUPArea_inhibition<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforPilarTraitsMarch27thThinnedSnpsWithCor/GAPIT.Association.GWAS_Results.BLINK.BLUPArea_inhibitionR3E3.csv")

dfBLINK.BLUPPercentage_inhibition<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforPilarTraitsMarch27thThinnedSnpsWithCor/GAPIT.Association.GWAS_Results.BLINK.BLUPPercentage_inhibitionR3E3.csv")
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforPilarTraitsMarch27thThinnedSnpsWithCor/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```
...
```{r, echo=FALSE}
tabledf<-read.csv("/Users/denizakdemir/Library/CloudStorage/GoogleDrive-deniz.akdemir.work@gmail.com/.shortcut-targets-by-id/1n5uwNs72GdTeZxmWZKLfFkgE0FIjPxVG/Akdemir_Deniz/github/GATKPIPE2/Rscripts/GWASforPilarTraitsMarch27thThinnedSnpsWithCorwoOutliers/GAPIT.Association.Filter_GWAS_results.csv")
tabledf<-tabledf[order(tabledf$P.value, decreasing = FALSE),]
knitr::kable(tabledf)
```
