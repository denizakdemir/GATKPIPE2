...
load("DataforPillarApr25/DataforPillarGWAS.RData")
...
new_dir <- "GWAS_resultsForPilarsTraitsApr25"
...
setwd("GWAS_resultsForPilarsTraitsApr25")
dim(BLUPS)
...
###############
getwd()
setwd("Rscripts/GWAS_resultsForPilarsTraitsApr25")
